                ...
                <?php
                    ...
                    $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                        ...
                        <table class="bordered" id="tbl">
                            <thead class="light-green accent-3" id="head">
                                <tr>
                        ...
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
								...
								if($_SESSION['id_user'] == '3'){
									$kondisi="kepala dinas";
                                $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk where keterangan !='$kondisi' ORDER by id_surat DESC LIMIT $curr, $limit");}
								else{
