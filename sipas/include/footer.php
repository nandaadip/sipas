...
<footer class="page-footer">
    ...
    <div class="footer-copyright green white-text">
        <div class="container" id="footer green">
            <?php
            ...
            <span class="white-text">&copy; <?php echo date("Y"); ?>
                <?php
                    if(!empty($data['nama'])){
                        echo $data['nama']/* .' &nbsp;|&nbsp; <a class="white-text" href="" target="_blank">By Nanda Adi Pratama</a>'*/;
                    } else {
                        echo 'Unila  &nbsp;|&nbsp; <a class="white-text" href="" target="_blank">By Nanda Adi Pratama</a>';
                    }
                ?>
            </a>
            </span>
