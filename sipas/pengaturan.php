        ...
        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
            ...
            if(isset($_REQUEST['sub'])){
                ...
                if(isset($_REQUEST['submit'])){
                    ...
                    if ($_REQUEST['institusi'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['status'] == "" || $_REQUEST['alamat'] == "" || $_REQUEST['kepala_dinas'] == "" || $_REQUEST['nip'] == ""
                        ...
                        $kepala_dinas = $_REQUEST['kepala_dinas'];
                        $nip = $_REQUEST['nip'];
                            ...
                            if(!preg_match("/^[a-zA-Z0-9. -]*$/", $institusi)){
                                ...
                                if(!preg_match("/^[a-zA-Z0-9.,:\/<> -\"]*$/", $status)){
                                    ...
                                    if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $alamat)){
                                        ...
                                        if(!preg_match("/^[a-zA-Z., ]*$/", $kepala_dinas)){
                                            $_SESSION['kepala_dinas'] = 'Form Nama Kepala Sekolah hanya boleh mengandung karakter huruf, spasi, titik(.) dan koma(,)<br/><br/>';
                                            echo '<script language="javascript">window.history.back();</script>';
                                        } else {

                                            if(!preg_match("/^[0-9 -]*$/", $nip)){
                                                $_SESSION['nipkepala_dinas'] = 'Form NIP Kepala Sekolah hanya boleh mengandung karakter angka, spasi, dan minus(-)<br/><br/>';
                                                echo '<script language="javascript">window.history.back();</script>';
                                            } else {
                                                        ...
                                                        if(!empty($logo)){
                                                            ...
                                                            if(in_array($eks, $ekstensi) == true){
                                                                if($ukuran < 2000000){
                                                                    ...
                                                                    $query = mysqli_query($config, "UPDATE tbl_instansi SET institusi='$institusi',nama='$nama',status='$status',alamat='$alamat',kepala_dinas='$kepala_dinas',nip='$nip',website='$website',email='$email',logo='$nlogo',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                                                            ...
                                                            $query = mysqli_query($config, "UPDATE tbl_instansi SET institusi='$institusi',nama='$nama',status='$status',alamat='$alamat',kepala_dinas='$kepala_dinas',nip='$nip',website='$website',email='$email',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                            ...
                            <form class="col s12" method="post" action="?page=sett" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="kepala_dinas" type="text" class="validate" name="kepala_dinas" value="<?php echo $row['kepala_dinas']; ?>" required>
                                            <?php
                                                if(isset($_SESSION['kepala_dinas'])){
                                                    $kepala_dinas = $_SESSION['kepala_dinas'];
                                                    echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$kepala_dinas.'</div>';
                                                    unset($_SESSION['kepala_dinas']);
                                                }
                                            ?>
                                        <label for="kepala_dinas">Nama Kepala Dinas</label>
                                    </div>
                                    <div class="input-field col s6">
                                    ...
                                    <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Jika  belum memiliki NIP, isi dengan minus(-)">
                                        ...
                                        <input id="nip" type="text" class="validate" name="nip" value="<?php echo $row['nip']; ?>" required>
                                            <?php
                                                if(isset($_SESSION['nipkepala_dinas'])){
                                                    $nipkepala_dinas = $_SESSION['nipkepala_dinas'];
                                                    echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$nipkepala_dinas.'</div>';
                                                    unset($_SESSION['nipkepala_dinas']);
                                                }
                                            ?>
